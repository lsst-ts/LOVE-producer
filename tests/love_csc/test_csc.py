...
from love.producer.love_csc.csc import LOVECsc
...
class TestLOVECsc(unittest.IsolatedAsyncioTestCase):
...
class TestWebsocketsClient(test_utils.WSClientTestCase):
    async def test_csc_client(self):
        async def arrange():
            from love.producer.love_csc.client import LOVEWSClient
